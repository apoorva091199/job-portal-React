    ...
    <div className="account_components">
      ...
      <div>
        ...
        <select value={location} onChange={(e) => setLocation(e.target.value)}>
          ...
          {cities.map((elements) => {
            return <option key={elements} value={elements}>{elements}</option>;
          })}
        </select>
      </div>
      <div>
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Briefly introduce your company and the job role to attract potential candidates."
          rows={7}
        />
      </div>
      <div>
        ...
        <textarea
          ...
          placeholder="Describe the responsibilities of the role."
          rows={7}
        />
      </div>
      <div>
        ...
        <textarea
          ...
          placeholder="List the qualifications and skills required for the role."
          rows={7}
        />
      </div>
      <div>
